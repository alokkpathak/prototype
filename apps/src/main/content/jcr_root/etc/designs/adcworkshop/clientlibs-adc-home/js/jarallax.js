...
(function(factory) {
    ...
    var Jarallax = (function() {
        ...
        function Jarallax(item, userOptions) {
            ...
            _this.image      = {
                ...
                useImgTag  : false // used to be isAndroid
            }
    ...
    Jarallax.prototype.init = function() {
        ...
        // slide has height of window
        _this.$item.css({height: $(window).height()});
    ...
    Jarallax.prototype.coverImage = function() {
        ...
        // for div with background image
            ...
            // hard coding values to fix image issue in higher resolutions (in mac 1920 width). This is not impacting other breakpoints.
    ...
    Jarallax.prototype.onScroll = function() {
        ...
        var _backgroundPosition ="75% 50%";
        //commenting below two lines as isPortrait is undefined and in iPad it always used to pick background position 50% 50%
        //if(isIpad && !isPortrait())
        	//_backgroundPosition ="85% 50%";
