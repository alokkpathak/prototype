                  ...
                  <div class="modal-dialog ">
                      <div class="modal-content">
                          ...
                          <div id="before-submit">
                            ...
                            <div class="form-group text-left email-form-group">
                               <label for="email" class="emaillabel">${properties.pfield}*</label>
                                <input type="email" class="form-control it-form-control" name="email" id="email" data-lbl="${properties.pfield}" maxlength="255" aria-required="true">
                            ...
                            <div id="after-submit">
                              ${properties.successtext}
                                <a adhocenable="false" id="resend" class="resend-email">${properties.resendmail}</a>

							</div>
                              <div id="after-resend-submit">
                          ...
                          <div class="modal-footer forget-modal-footer">
                              ...
                              <a class="btn btn-lg button-orange" id="retrieve-pwd"  style="background-color:#E4572D;">${properties.rpwd}</a>
                            </div>
                      </div>
                  </div>
                  </form>
